          ...
          <div className="flex items-center justify-between sm:flex-col md:flex-col border-t border-t-second py-5">
            <div className="flex items-start justify-center sm:flex-col gap-3">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-sm py-5 w-[70%] sm:w-full md:w-full font-open">
                  This platform fuses innovation, creativity, and play through a
                  sleek, immersive design that embodies Venture Verse’s spirit
                  of digital exploration. Subtle gradients, fluid animations,
                  and interactive elements draw users into a world where
                  technology meets imagination. From minting NFTs to showcasing
                  ventures and games, every detail feels intentional and
                  futuristic — reflecting the platform’s mission to empower
                  creators, gamers, and investors to own, build, and shape the
                  next frontier of Web3.
                </p>
                <ul className="flex sm:grid sm:grid-cols-3 gap-3 sm:gap-1 sm:mb-3 font-open">
                  <li className="bg-second text-primary text-sm px-3 py-2 rounded-sm cursor-pointer">
                    Next.js
