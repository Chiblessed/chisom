  ...
  return (
    <>
      <header className="my-11 z-50 sm:my-16 shadow-md shadow-third rounded-3xl sm:flex sm:items-center sm:justify-between sm:w-full sm:py-3 sm:px-5 bg-primary/85 fixed top-0 left-1/2 -translate-x-1/2 ">
          ...
          <ul className="flex items-center justify-center gap-4 sm:hidden">
            <li
              className="px-6 py-3 rounded-3xl cursor-pointer
               ...
               hover:bg-second hover:text-primary hover:scale-105 hover:shadow-md"
            >
              {" "}
              <Link href="/">Home</Link>
            </li>
        ...
        <div className="md:hidden sm:visible relative">
          <button
            onClick={toggleNavbar}
            className="flex flex-col justify-between w-8 h-6 focus:outline-none"
          >
            <span
              className={`block h-1 w-full bg-black rounded transform transition-all duration-300 ${
            ...
            <span
              className={`block h-1 w-full bg-black rounded transform transition-all duration-300 ${
                active ? "-rotate-[40deg] -translate-y-[11px]" : ""
              }`}
            ></span>
          </button>
        </div>
        {active && (
          <motion.div className="absolute z-10 top-12 right-0 w-full h-[50vh] bg-primary/75 rounded-[10px] text-third">
            <div className="pt-10 flex flex-col items-center justify-center gap-10">
              <button
                onClick={() => setActive(false)}
                className={`font-open font-semibold text-2xl hover:cursor-pointer  hover:border-b hover:border-b-third transition-all`}
              >
                <Link href="/">Home</Link>
              </button>
              <button
              ...
              <div className="flex items-center justify-center gap-10 pb-10">
                <Link
                  href="https://github.com/Chiblessed"
                ...
                <Link
                  href="www.linkedin.com/in/chisom-ohanu-897a37230"
                  className="bg-primary px-5 py-1 rounded"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 50 50"
      ...
      {/**   <header className="flex items-center justify-between px-16 py-5 w-full sm:px-3 bg-primary">
        <h2
          className={`font-oswald z-20 text-4xl font-semibold hover:cursor-pointer `}
        >
          <Link href="/">Chisom.</Link>
        </h2>
      ...
      {/*     <motion.span
        ...
        {active && (
          <motion.div className="absolute z-10 top-0 pt-32 right-0 w-full h-[110vh] bg-second rounded-[10px] text-primary">
            <div className="pt-10 flex flex-col items-center justify-center gap-10">
              <button
                onClick={() => setActive(false)}
                className={`font-open font-semibold text-2xl hover:cursor-pointer  hover:border-b hover:border-b-primary transition-all`}
              >
                <Link href="/">Home</Link>
              </button>
              <button
                onClick={() => setActive(false)}
                className={`font-open font-semibold   text-8xl hover:cursor-pointer  hover:border-b hover:border-b-primary transition-all`}
              >
                <Link href="/about">About</Link>
              </button>
              <button
